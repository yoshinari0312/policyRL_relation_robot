...
"""
    ...
    prompt_lines = [
        ...
        *history_lines,
        ...
        "",
        "【判断基準】",
        f"会話から{target_speaker}が求めているもの（承認、仲裁、解決策、独立）を推測してください：",
        "- 承認や共感を求めている → 1 (validate)",
        "- 仲裁や調和を求めている、対立を収めたがっている → 2 (bridge)",
        "- 具体的な解決策や行動を求めている → 3 (plan)",
        "- 放っておいてほしい、自分で解決したい → 4 (no_intervention)",
    ]
    user_content = "\n".join(prompt_lines)
